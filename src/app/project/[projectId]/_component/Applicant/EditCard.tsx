import { updateApplicantApplicationMessageApi } from "@/apis/applicant/applicantApis";
...
export default function EditCard({ setIsEdit, applicant }: { setIsEdit: Dispatch<SetStateAction<boolean>>; applicant: Applicant }) {
    ...
    const onUpdateApplicationMessageMutation = useMutation({
        mutationFn: updateApplicantApplicationMessageApi,
        onMutate: () => {
            spinner.open();
        },
        onSuccess: (response) => {
