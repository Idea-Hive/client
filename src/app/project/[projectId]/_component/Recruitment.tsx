    ...
    return (
        <div>
            ...
            <div className="w-[732px] flex flex-wrap gap-[9px]">
                {data.projectSkillStacks.length > 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center gap-3 mx-auto mt-5">
                        ...
                        <div className="text-base text-n800">작성된 기술 스펙이 없습니다.</div>
                    </div>
                )}
            </div>
