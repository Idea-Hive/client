        ...
        <div className="w-full pb-[60px]">
            ...
            <div className="w-[1200px] mx-auto relative">
                ...
                <div className="w-full flex justify-center">
                    <Pagination page={1} totalPage={10} onChange={() => {}} />
                </div>
            </div>
...
const FloatBtn = () => {
    return (
        <button className="fixed right-[140px] bottom-[135px] w-[70px] h-[70px] bg-taskmateRed rounded-full flex items-center justify-center hover:bg-[#f54b4a]">
